...
if (isset($_POST['simpan'])) {
    ...
    if ($_GET['hal'] == "edit") {
        ...
        $simpan = mysqli_query($koneksi, "INSERT INTO kelasmatapelajaran (idKelasMataPelajaran, idKelas, idMapel, nip, idJadwal, tahunAjaran) 
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                Form Registrasi Kelas mata pelajaran
            </div>
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="form-label-group">
                        ...
                        ?>
                        <select name="tidKelas" id="idKelas" class="form-control">
